...
class Assess extends StatefulWidget {
  const Assess({super.key, required this.goToWidget});

  final void Function(String widgetName) goToWidget;

  @override
  State<Assess> createState() {
...
/*     print('-------------');
    ...
    if (jsonDataReturned["conceptBasedQuestion"] == null) {
      processInExecution = true;
      setState(() {});
    } else {
  ...
  Future<String> getAssessment() async {
    ...
    if (jsonDataReturned["Question"] == null || allOptions.isEmpty) {
      processInExecution = true;
      setState(() {});
    } else {
      processInExecution = false;
  ...
  Widget build(BuildContext context) {
    ...
    if (currentQuizType == 0 && processInExecution) {
      getAssessment();
    } else if (currentQuizType == 1 && processInExecution) {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (currentQuizType == 0 && processInExecution == false)
                  ...
                  if (currentQuizType == 1 && processInExecution == false)
                    if (jsonDataReturned != null)
                      QuizNuggetsNotes(
